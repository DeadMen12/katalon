...
WebUI.scrollToElement(findTestObject('Promosi Nasional/Promo Semua/Scroll Informasi Bawah'), 0)

WebUI.click(findTestObject('Promosi Nasional/Promo Semua/Lihat Selengkapnya'))

WebUI.click(findTestObject('Promosi Nasional/Promo Semua/Lihat Lebih Sedikit'))

WebUI.scrollToElement(findTestObject('Promosi Nasional/Promo Semua/Scroll FAQ'), 0)

WebUI.click(findTestObject('Promosi Nasional/Promo Semua/Faq Promo Nasional'))

WebUI.click(findTestObject('Promosi Nasional/Promo Semua/Faq Promo Nasional'))

WebUI.scrollToPosition(0, 36)
...
for (int i = 1; i <= totalCards; i++) {
    ...
    cardToSelect.addProperty('xpath', ConditionType.EQUALS, ('//a[starts-with(@id, "card-promo-")] [' + i) + ']')
    ...
    if (formExists) {
        ...
        if (WebUI.verifyElementPresent(findTestObject('Object Repository/Events/Minta Penawaran/Model Mobil'), 30, FailureHandling.OPTIONAL)) {
            ...
            WebUI.click(findTestObject('Promosi Nasional/Promo Mobil Baru/Minta Penawaran/Isi Model Mobil'), FailureHandling.STOP_ON_FAILURE)
        } else {
